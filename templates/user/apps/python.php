    ...
    modal.innerHTML = `
        <div style="background: var(--bg-card); border-radius: 8px; width: 100%; max-width: 900px; max-height: 90vh; display: flex; flex-direction: column; box-shadow: 0 10px 40px rgba(0,0,0,0.5);">
            <div style="padding: 20px; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
                <h3 style="margin: 0; font-size: 18px; font-weight: 600;"><i data-lucide="terminal" style="width: 20px; height: 20px; vertical-align: middle; margin-right: 8px;"></i>Deployment Logs - ${serviceName}</h3>
                <button onclick="closeDeploymentLogs()" style="background: none; border: none; color: var(--text-color); font-size: 28px; cursor: pointer; padding: 0; line-height: 1; opacity: 0.7;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.7'">&times;</button>
            </div>
            <div style="flex: 1; overflow: hidden; position: relative;">
                <div id="deployment-logs-content" style="background: #0d1117; color: #58a6ff; font-family: 'SF Mono', Monaco, monospace; font-size: 13px; line-height: 1.6; padding: 20px; height: 500px; overflow-y: auto; white-space: pre-wrap; word-wrap: break-word;">
                    <div style="color: #8b949e;"><i data-lucide="loader" style="width: 16px; height: 16px; vertical-align: middle; margin-right: 8px;"></i>Fetching deployment logs...</div>
                </div>
                <div id="deployment-status" style="position: absolute; top: 10px; right: 10px; background: rgba(13, 17, 23, 0.9); padding: 6px 12px; border-radius: 4px; font-size: 12px; color: #58a6ff; display: none;">
            ...
            <div style="padding: 16px 20px; border-top: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
                <div style="font-size: 12px; color: var(--text-muted);"><i data-lucide="info" style="width: 14px; height: 14px; vertical-align: middle; margin-right: 4px;"></i>Auto-refreshing every 2 seconds</div>
                <div style="display: flex; gap: 10px;">
                    <button class="btn btn-secondary" onclick="closeDeploymentLogs()">Close</button>
                    <button class="btn btn-primary" onclick="refreshDeploymentLogs(${serviceId})" id="refresh-logs-btn"><i data-lucide="refresh-cw" style="width: 16px; height: 16px; vertical-align: middle; margin-right: 4px;"></i>Refresh</button>
                </div>
            </div>
        </div>
    `;
