...
<script>
                    ...
                    <tr>
                        ...
                        <td class="actions-col">
                            <div style="display:flex;gap:5px;justify-content:flex-end;">
                                <a href="${window.base_url || ''}/public/adminer.php?server=${db.host}&username=${db.user}&db=${db.name}" target="_blank" class="btn btn-sm btn-secondary" title="Login to Adminer">
    ...
    function loginToAdminer(driver, host, user, encryptedPass, db) {
        // Construct Adminer URL with pre-filled parameters
        // Adminer URL format: https://db.domain/?server=HOST&username=USER&db=NAME
        const domain = window.location.hostname;
        const adminerUrl = `https://db.${domain}/?server=${host}&username=${user}&db=${db}`;
                ...
                await showCustomAlert({
                    ...
                    html: `<div style="text-align:left;font-size:13px;background:#f3f4f6;padding:12px;border-radius:6px;border:1px solid #e5e7eb;margin-bottom:12px">
                           ...
                           <div style="margin-top:15px; text-align:center;">
                                <a href="https://db.${window.location.hostname}/?server=${data.database.host}&username=${data.database.user}&db=${data.database.name}" 
                                   target="_blank" 
