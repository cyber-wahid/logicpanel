...
class DatabaseProvisionerService
{
    ...
    public function deleteMySQLDatabase(int $userId, int $dbId, string $dbName, string $dbUser): void
    {
    ...
    public function deletePostgreSQLDatabase(int $userId, int $dbId, string $dbName, string $dbUser): void
    {
    ...
    public function deleteMongoDBDatabase(int $userId, int $dbId, string $dbName, string $dbUser): void
    {
