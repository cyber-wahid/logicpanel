...
class ServiceController
{
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        try {
            ...
            // Resource Limits (Enforce LogicDock Package Limits)
    ...
    private function writeEnvFile(Service $service, array $envVars): void
    {
        ...
        $content = "# Auto-generated by LogicDock - Do not edit manually\n";
    ...
    public function command(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        // LogicDock maps volume to /storage. Container is started with WORKDIR /storage/{name}
    ...
    public function delete(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        $containerName = "logicdock_app_service_{$service->id}";
