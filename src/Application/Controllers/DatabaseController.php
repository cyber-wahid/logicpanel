...
class DatabaseController
{
    ...
    public function delete(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            // Call provisioner to delete database, passing actual dbName and dbUser to avoid suffix mismatch
            match ($database->db_type) {
                'mysql' => $this->provisionerService->deleteMySQLDatabase($userId, $database->id, $database->db_name, $database->db_user),
                'postgresql' => $this->provisionerService->deletePostgreSQLDatabase($userId, $database->id, $database->db_name, $database->db_user),
                'mongodb' => $this->provisionerService->deleteMongoDBDatabase($userId, $database->id, $database->db_name, $database->db_user),
            };
